...
export const L = {
  ...
  SUB_DIP_START_Y: 36,
  SUB_DIP_ROW_GAP: 46,
  SUB_TRANSPORT_CYCLE_Y: 80,
  SUB_TRANSPORT_LIST_Y: 20,
  SUB_TRANSPORT_ROW_GAP: 70,
  ...
  DEPLOY_FRAME_W: 660,
  DEPLOY_FRAME_H: 900,
  DEPLOY_SEC_LABEL_Y: 348,
  DEPLOY_TAC_LABEL_Y: 198,
  DEPLOY_INFO_Y: 120,
  DEPLOY_GEN_Y: 320,
  DEPLOY_SEC_Y: 272,
  DEPLOY_RATIO_Y: 224,
  ...
  MENU_TITLE_Y: 360,
  /** 主菜单 Logo 顶边 Y（锚点在上沿，靠近屏幕上缘 640） */
  MENU_LOGO_TOP_Y: 612,
  MENU_LOGO_W: 480,
  MENU_LOGO_H: 176,
  MENU_BUILD_TAG_X: 300,
  MENU_BUILD_TAG_Y: -610,
  /** 文字主菜单首项（Logo 区下方，落在大厅桌案区） */
  MENU_ITEMS_START_Y: 60,
  MENU_ITEM_GAP: 58,
  MENU_ITEM_EXIT_GAP: 76,
  MENU_ITEM_W: 400,
  MENU_ITEM_H: 48,
  MENU_ITEM_FONT: 34,
  MENU_ITEM_SPACING_X: 6,
  MENU_LINE_W: 240,

  /** 大厅二级页 */
  LOBBY_TITLE_Y: 500,
  LOBBY_SUBTITLE_Y: 448,
  LOBBY_BACK_Y: -560,
  LOBBY_LIST_START_Y: 280,
  LOBBY_LIST_GAP: 58,
  LOBBY_BODY_W: 620,
  LOBBY_BODY_Y: 80,
  LOBBY_ACTION_Y: -120,
  LOBBY_DETAIL_STATS_Y: 200,
  /** 武将图鉴：兵种筛选 + 可滚动表格 */
  LOBBY_GALLERY_FILTER_Y: 400,
  LOBBY_GALLERY_TABLE_HEADER_Y: 355,
  LOBBY_GALLERY_TABLE_ROW_H: 38,
  LOBBY_GALLERY_TABLE_W: 680,
  LOBBY_GALLERY_SCROLL_TOP: 328,
  LOBBY_GALLERY_SCROLL_BOTTOM: -450,
  LOBBY_GALLERY_SCROLL_H: 778,
  LOBBY_GALLERY_SCROLL_CENTER_Y: -61,
  LOBBY_GALLERY_COUNT_Y: -500,
  LOBBY_GALLERY_DETAIL_W: 660,
  LOBBY_GALLERY_DETAIL_H: 1080,
  LOBBY_GALLERY_DETAIL_PORTRAIT_W: 240,
  LOBBY_GALLERY_DETAIL_PORTRAIT_H: 300,
  LOBBY_GALLERY_DETAIL_PORTRAIT_Y: 130,
  /** 武将编辑（设置 → 武将编辑） */
  EDITOR_TITLE_Y: 580,
  EDITOR_LIST_HEADER_Y: 500,
  EDITOR_LIST_FIRST_ROW_Y: 460,
  EDITOR_LIST_ROW_H: 34,
  EDITOR_LIST_ROWS: 12,
  EDITOR_LIST_W: 680,
  EDITOR_PORTRAIT_X: -170,
  EDITOR_PORTRAIT_Y: 360,
  EDITOR_PORTRAIT_W: 150,
  EDITOR_PORTRAIT_H: 190,
  EDITOR_NAME_X: 90,
  EDITOR_NAME_Y: 430,
  EDITOR_META_Y: 360,
  EDITOR_STAT_SECTION_Y: 260,
  EDITOR_STAT_FIRST_Y: 200,
  EDITOR_STAT_ROW_H: 48,
  EDITOR_SKILL_Y: -40,
  EDITOR_ACTION_Y: -460,
  EDITOR_BACK_LIST_Y: -540,
  LOBBY_BG_PREVIEW_Y: 240,
  LOBBY_BG_LABEL_Y: 40,
  LOBBY_BG_NAV_Y: -80,
  LOBBY_BG_ACTION_Y: -160,
  LOBBY_SETTINGS_START_Y: 300,
  LOBBY_SETTINGS_GAP: 56,
  LOBBY_SETTINGS_DANGER_Y: -420,
  LOBBY_SETTINGS_EXTRA_Y: -480,
...
export const COL = {
  ...
  /** 主菜单文字（暖白 · 碑刻感） */
  menuText: { r: 245, g: 236, b: 214, a: 255 },
  /** 主菜单点击/强调（暗金） */
  menuGold: { r: 198, g: 162, b: 72, a: 255 },
